            ...
            describe("Get motestatusendringer") {
                ...
                it("returns motestatusendringer for person") {
                    ...
                    with(
                        ...
                        statusendringer[0].opprettetAv shouldBeEqualTo VEILEDER_IDENT
                        statusendringer[0].status shouldBeEqualTo DialogmoteStatus.INNKALT
                        statusendringer[0].dialogmote.tid shouldBeEqualTo newDialogmote.tidSted.tid
                        statusendringer[0].dialogmote.opprettetAv shouldBeEqualTo VEILEDER_IDENT
                    }
                }
                ...
                it("returns several motestatusendringer for one mote") {
                    ...
                    with(
                        ...
                        statusendringer[0].opprettetAv shouldBeEqualTo VEILEDER_IDENT_2
                        statusendringer[0].status shouldBeEqualTo DialogmoteStatus.NYTT_TID_STED
                        statusendringer[0].dialogmote.tid shouldBeEqualTo newDialogmote.tidSted.tid
                        statusendringer[0].dialogmote.opprettetAv shouldBeEqualTo VEILEDER_IDENT

                        statusendringer[1].opprettetAv shouldBeEqualTo VEILEDER_IDENT
                        statusendringer[1].status shouldBeEqualTo DialogmoteStatus.INNKALT
                        statusendringer[1].dialogmote.tid shouldBeEqualTo newDialogmote.tidSted.tid
                        statusendringer[1].dialogmote.opprettetAv shouldBeEqualTo VEILEDER_IDENT
                    }
                }
                ...
                it("returns motestatusendringer for several moter") {
                    ...
                    with(
                        ...
                        statusendringer[1].dialogmote.tid shouldBeEqualTo newDialogmoteFerdigstilt.tidSted.tid
                        statusendringer[1].dialogmote.opprettetAv shouldBeEqualTo VEILEDER_IDENT

                        statusendringer[2].opprettetAv shouldBeEqualTo VEILEDER_IDENT
                        statusendringer[2].status shouldBeEqualTo DialogmoteStatus.INNKALT
                        statusendringer[2].dialogmote.tid shouldBeEqualTo newDialogmote.tidSted.tid
                        statusendringer[2].dialogmote.opprettetAv shouldBeEqualTo VEILEDER_IDENT
                    }
                }
            }
        }
