...
class GetDialogmoteEnhetApiV2Test {
    ...
    @Nested
    @DisplayName("Get Dialogmoter for EnhetNr")
    inner class GetDialogmoterForEnhetNr {
        ...
        inner class HappyPath {
            ...
            fun `should return DialogmoteList with unfinished dialogmote if request is successful`() {
                testApplication {
                    ...
                    assertEquals(newDialogmote.arbeidsgiver.virksomhetsnummer.value, dialogmoteDTO_0.arbeidsgiver.virksomhetsnummer)
                    ...
                    assertEquals(newDialogmoteDTO.arbeidsgiver.virksomhetsnummer, dialogmoteDTO_1.arbeidsgiver.virksomhetsnummer)
