...
class ArbeidstakerBrevApiTest {
    ...
    @Nested
    @DisplayName("Les og respons ArbeidstakerBrev")
    inner class LesOgResponsArbeidstakerBrev {
            ...
            fun `should return OK if request is successful`() {
                testApplication {
                    ...
                    client.getDialogmoter(validTokenVeileder, ARBEIDSTAKER_FNR).apply {
                        ...
                        assertEquals("Det passer bra();_code_, med nørskeÆØÅ bokstaver og noen spesialtegn %!()?.", dialogmoteDTO.arbeidstaker.varselList[0].svar!!.svarTekst)
                    }
            ...
            fun `should return OK if request is successful`() {
                testApplication {
                    ...
                    client.get(urlPdfForInnkallingNedlasting) {
                        ...
                        assertEquals(pdfInnkalling, pdfContent)
                    }
                    ...
                    client.get(urlPdfForReferatNedlasting) {
                        ...
                        assertEquals(HttpStatusCode.OK, status)
                        val pdfContent = bodyAsChannel().toByteArray()
                        assertEquals(pdfReferat, pdfContent)
                    }
                }
            }
        }
