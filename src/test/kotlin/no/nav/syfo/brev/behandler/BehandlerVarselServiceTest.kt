...
class BehandlerVarselServiceTest {
    ...
    @Nested
    @DisplayName("BehandlerVarselService handles sending of varsler to behandler and storing svar")
    inner class HandlesVarslerAndSvar {

        @Nested
        @DisplayName("find related varsel and store behandlersvar in database")
        inner class FindVarselAndStore {
