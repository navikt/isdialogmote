...
class PublishDialogmotesvarBehandlerServiceTest {
    ...
    private lateinit var publishDialogmotesvarService: PublishDialogmotesvarService

    @BeforeEach
    fun beforeEach() {
        publishDialogmotesvarService = PublishDialogmotesvarService(database, dialogmotesvarProducer)
    ...
    @Nested
    @DisplayName("Mark møtesvar from behandler as published in the database")
    inner class MarkAsPublished {
