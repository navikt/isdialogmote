...
class DialogmoteOutdatedCronjobTest {
    ...
    private lateinit var behandlerVarselService: BehandlerVarselService
    ...
    private lateinit var oppfolgingstilfelleClient: OppfolgingstilfelleClient
    private lateinit var dialogmotestatusService: DialogmotestatusService
    private lateinit var arbeidstakerVarselService: ArbeidstakerVarselService
    private lateinit var dialogmotedeltakerService: DialogmotedeltakerService
    private lateinit var dialogmoterelasjonService: DialogmoterelasjonService
    private lateinit var dialogmoteOutdatedCronjob: DialogmoteOutdatedCronjob
    ...
    fun beforeEach() {
        ...
        dialogmoteOutdatedCronjob = DialogmoteOutdatedCronjob(
            dialogmotestatusService = dialogmotestatusService,
            dialogmoterelasjonService = dialogmoterelasjonService,
            database = database,
    ...
    @Nested
    @DisplayName("Cronjob for status paa gamle moter")
    inner class CronjobForStatus {
