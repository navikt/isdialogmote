...
class PublishDialogmoteStatusEndringCronjobTest {
    ...
    private lateinit var moteStatusEndretRepository: MoteStatusEndretRepository
    ...
    private lateinit var publishDialogmoteStatusEndringService: PublishDialogmoteStatusEndringService
    private lateinit var publishDialogmoteStatusEndringCronjob: PublishDialogmoteStatusEndringCronjob
    ...
    fun beforeEach() {
        ...
        publishDialogmoteStatusEndringCronjob = PublishDialogmoteStatusEndringCronjob(
            publishDialogmoteStatusEndringService = publishDialogmoteStatusEndringService,
        )
    ...
    @Nested
    @DisplayName("Publish DialogmoteStatusEndring for types of StatusEndret")
    inner class PublishStatusEndring {
