...
class DialogmeldingServiceTest {
    ...
    inner class HandlerDialogmeldingSvarFraBehandlerPaEndring {
        ...
        @Test
        fun `Oppretter varsel-svar når dialogmelding inneholder aktuell arbeidstaker og conversationRef refererer til innkalling-varsel og finnes endrings-varsel for arbeidstaker i samme møte`() {
