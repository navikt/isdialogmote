...
val COUNT_CALL_PERSON_KONTAKTINFORMASJON_SUCCESS: Counter = Counter
    ...
    .description("Counts the number of successful calls to Syfoperson - Kontaktinformasjon")
    .register(METRICS_REGISTRY)
val COUNT_CALL_PERSON_KONTAKTINFORMASJON_FAIL: Counter = Counter
    .builder(CALL_PERSON_KONTAKTINFORMASJON_FAIL)
    .description("Counts the number of failed calls to Syfoperson - Kontaktinformasjon")
    .register(METRICS_REGISTRY)
...
val COUNT_CALL_PERSON_OPPFOLGINGSTILFELLE_FAIL: Counter = Counter
    ...
    .description("Counts the number of failed calls to Syfoperson - Oppfolgingstifelle")
    .register(METRICS_REGISTRY)
